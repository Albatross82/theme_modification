 ...
 <table style="border:1px solid #d6d6d6" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0" width="100%">
                  <tr>
                     <td align="center">
                        ...
                        <h1 align="center" style="font-size:22px; font-weight:400">Ваш заказ передан<br>в курьерскую службу</h1>
...
Вы оформляли доставку курьером по Москве, Ваш заказ передан в курьерскую
службу. Предварительно курьер с Вами созвониться и договориться об удобном
для Вас времени доставки заказа на указанный адрес.
<br>
