...
<style>
dt.variation-projectref{display: none;}
dd.variation-projectref{display: none;}
</style>
...
<?php if( $wpo_wcpdf->get_header_logo_id() ) echo apply_filters( 'wpo_wcpdf_invoice_title', __( 'Бланк заказа', 'wpo_wcpdf' ) ); ?>
</h1>
		...
		<td class="order-data">
			<table>
				...
				<tr class="order-number">
					...
					<td><?php echo get_post_meta($wpo_wcpdf->export->order->id, 'taopix_id', true); ?></td>
				</tr>
				<tr class="order-date">
...
<table class="order-details" style="width:650px;">
	<thead>
		<tr>
