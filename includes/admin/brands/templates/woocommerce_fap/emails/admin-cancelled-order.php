 ...
 */
 ...
 do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
               ...
               <table style="border:1px solid #d6d6d6" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0" width="100%">
                  <tr>
                     <td align="center">
                        <img src="http://picsprint.ru/wp-content/uploads/2017/03/picsprint_logo_h80px.png">
                        <div align="left" style="padding-left:30px; padding-right:30px;">
                        <h1 align="center" style="font-size:22px; font-weight:400">Ошибка загрузки заказа<br>с сайта PicsPrint</h1>
 <h3 style="display:block; background:#000; color:#fff; padding-top:10px; padding-bottom:10px; text-align:center;"><?php echo $user_login; ?>, рекомендации по загрузке</h3>                       
При оформлении заказа у Вас прервалась сессия и заказ не получилось оплатить и загрузить.
<br><br>
Вам необходимо вернуться в корзину и продолжить оформление заказа. Оплата заказа должна быть произведена в течение (!) 10-15 минут!
...
(google диск) и пришлите нам ссылку на почту <a href="mailto:order@picsprint.ru">order@picsprint.ru</a></span>
<br><br>
