               ...
               <table style="border:1px solid #d6d6d6" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0" width="100%">
                  <tr>
                     <td align="center">
                        ...
                        <h1 align="center" style="font-size:22px; font-weight:400">Ошибка загрузки заказа<br>с сайта МоиФотоСтраницы</h1>
...
(google диск) и пришлите нам ссылку на почту <a href="mailto:order@myphotopages.ru">order@myphotopages.ru</a></span>
<br><br>
